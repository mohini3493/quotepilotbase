...
export default function EditExternalColorPage() {
  const { id } = useParams<{ id: string }>();
  const router = useRouter();
  const [form, setForm] = useState<ExternalColor | null>(null);
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <h1 className="text-2xl font-semibold">Edit External Color</h1>
